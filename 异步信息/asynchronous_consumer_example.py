...
class ExampleConsumer(object):
    ...
    def start_consuming(self):
        ...
        # 如果rabbitmq取消了队列，则调用这里
        self.add_on_cancel_callback()
        # 调用信道接收消息，传入队列名称和callback
